...
public class YesNoDialog extends AbstractDialog {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new AlertDialog.Builder(ctx).setMessage(messageId).setTitle(titleId).setPositiveButton(R.string.yes, bListener).setNegativeButton(R.string.no, bListener).create();
    }
