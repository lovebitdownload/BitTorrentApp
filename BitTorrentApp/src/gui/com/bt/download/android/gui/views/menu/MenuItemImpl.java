...
package com.bt.download.android.gui.views.menu;
    ...
    MenuItemImpl(MenuBuilder menu, int group, int id, int categoryOrder, int ordering,
        ...
        if (sPrependShortcutLabel == null || !lang.equals(sLanguage)) {
            ...
            sPrependShortcutLabel = menu.getContext().getResources().getString(
                    com.bt.download.android.R.string.prepend_shortcut_label);
            sEnterShortcutLabel = menu.getContext().getResources().getString(
                    com.bt.download.android.R.string.menu_enter_shortcut_label);
            sDeleteShortcutLabel = menu.getContext().getResources().getString(
                    com.bt.download.android.R.string.menu_delete_shortcut_label);
            sSpaceShortcutLabel = menu.getContext().getResources().getString(
                    com.bt.download.android.R.string.menu_space_shortcut_label);
        }
